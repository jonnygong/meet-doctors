    ...
    <section>
        ...
        <el-table :data="list"
            ...
            <el-table-column prop="img_type" label="图片类型" min-width="120">
                <template scope="scope">
                    {{ options.img_type[scope.row.img_type] }}
                </template>
            </el-table-column>
            <!-- 图片显示 -->
            <el-table-column prop="img_url" label="封面图片" width="130">
                <template scope="scope">
...
//          key: this.filters.key, // 可选参数查询
          img_type: this.filters.value // 可选参数查询
        };
