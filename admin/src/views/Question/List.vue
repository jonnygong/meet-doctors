<template>
    <section>
        ...
        <el-table :data="list"
            ...
            <el-table-column prop="answer" label="答案选择" min-width="120">
                <template scope="scope">
                    <p>选项A：{{ scope.row.answer[0].name }}</p>
                    <p>选项B：{{ scope.row.answer[1].name }}</p>
                </template>
            </el-table-column>
            <!--<el-table-column prop="answer[1]" label="答案选择B" min-width="120">-->
            <!--</el-table-column>-->
            <el-table-column prop="result" label="正确答案" min-width="100">
                <template scope="scope">
                    {{ options.result[scope.row.result] }}
                </template>
            </el-table-column>
            <el-table-column prop="category_id" label="视频分类" min-width="120">
                <template scope="scope">
...
<script>
  ...
  const MODEL_NAME = 'Question'; // API模块名
