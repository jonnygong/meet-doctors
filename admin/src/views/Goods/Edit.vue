<template>
    <div class="form-wrapper">
        <el-form :model="formData" label-width="120px" :rules="formRules" ref="formData">
            ...
            <!-- 多图片上传 -->
            <el-form-item label="产品图片" prop="img_url">
...
const MODEL_NAME = "Goods"; // http://api.zhongjiao.kfw001.com/webadmin/控制器/方法 -> 接口控制器名称
...
export default {
  ...
  methods: {
    ...
    //编辑
    formSubmit() {
      this.formData.img_url = this.getImageList("album"); // 多图上传
