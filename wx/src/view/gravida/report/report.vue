    ...
    <div class="bg">
      <div class="report">
        ...
        <dl>
          <dd>
            <h3>孕前得分：</h3>
            <h3>{{ score.front_score }}</h3>
          </dd>
          <dd>
            <h3>孕中得分：</h3>
            <h3>{{ score.in_score }}</h3>
          </dd>
          <dd>
            <h3>产后得分：</h3>
            <h3>{{ score.after_score }}</h3>
          </dd>
          <dd>
            <h3>康复得分：</h3>
            <h3>{{ score.recovery_score }}</h3>
          </dd>
          <dd>
            <h3>总成绩：</h3>
            <h3>{{ score.score }}</h3>
        ...
        <img v-if="score.after_score > 0 && score.after_score < 100" src="~@/assets/good.png" class="great">
        <div class="info">
          <h4>{{ score.name }}</h4>
...
<script>
import { formatDated } from '@/plugins/formatDateTime.js'
export default {
  data() {
    return {
      score: {
  ...
  mounted() {
    ...
    this.score.create_time = formatDated(this.score.create_time)
  }
}
</script>
